/*
 * @(#) $(JCGO)/goclsp/vm/gnu/java/lang/management/VMRuntimeMXBeanImpl.java --
 * VM specific runtime bean implementation.
 **
...
final class VMRuntimeMXBeanImpl
{
 ...
 private VMRuntimeMXBeanImpl() {}

 static native String[] getInputArguments(); /* JVM-core */
 ...
 {
  return VMAccessorJavaLang.getStartTimeMillisVMThread();
 }
}
