/*
 * @(#) $(JCGO)/goclsp/vm/gnu/java/lang/management/VMClassLoadingMXBeanImpl.java --
 * VM specific class loading bean implementation.
 **
...
final class VMClassLoadingMXBeanImpl
{
 ...
 private VMClassLoadingMXBeanImpl() {}
 ...
 static native long getUnloadedClassCount(); /* JVM-core */
