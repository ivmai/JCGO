/*
 * @(#) $(JCGO)/goclsp/vm/gnu/java/nio/EpollSelectorImpl.java --
 * VM selector implementation for systems with "epoll" notification.
 **
...
{ /* VM class */
  ...
  throws IOException
 {
  /* not implemented */
  super(provider);
  throw new InternalError("EpollSelectorImpl() not implemented");
 }
 ...
 void epoll_modify(EpollSelectionKeyImpl key, int ops)
  throws IOException
 {
  /* not implemented */
 }

 public static boolean epoll_supported()
 {
  return false;
 }
}
