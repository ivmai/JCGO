/*
 * @(#) $(JCGO)/goclsp/vm/gnu/java/nio/VMSelector.java --
 * VM specific file/socket "select" call implementation.
 **
...
public final class VMSelector
{
  ...
  throws IOException
 {
  ...
  return VMAccessorGnuJavaNet.socketSelectVMPlainSocketImpl(read, write,
          except, timeout > 0L ? (timeout < (long) (-1 >>> 1) ?
          (int) timeout : -1 >>> 1) : -1);
 }
}
