/*
 * @(#) $(JCGO)/goclsp/vm/java/lang/management/VMManagementFactory.java --
 * VM interface for obtaining memory system beans.
 **
...
final class VMManagementFactory
{
 ...
 {
  /* not implemented */
  return new String[] { "MemoryPool" };
 }

 static String[] getMemoryManagerNames()
 {
  /* not implemented */
  return new String[] { "MemoryManager" };
 }

 static String[] getGarbageCollectorNames()
 {
  /* not implemented */
  return new String[] { "GarbageCollector" };
 }
}
