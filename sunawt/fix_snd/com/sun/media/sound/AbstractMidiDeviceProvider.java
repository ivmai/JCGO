...
/*
 * @(#)AbstractMidiDeviceProvider.java  1.3 03/01/23
 *
...
public abstract class AbstractMidiDeviceProvider extends MidiDeviceProvider {
    ...
    synchronized void readDeviceInfos() {
        ...
        if (oldNumDevices != newNumDevices) {
            if (Printer.trace) Printer.trace(getClass().toString()+": readDeviceInfos: old numDevices: "+oldNumDevices+"  newNumDevices: " + newNumDevices);
