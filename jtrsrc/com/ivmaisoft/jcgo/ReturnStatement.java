...
final class ReturnStatement extends LexNode
{
 ...
 void processPass1(Context c)
 {
  ...
  {
   if (md.isConstructor())
    fatalError(c, "Return expression is not allowed for constructors");
   ...
   else if (!md.isConstructor() && md.exprType().objectSize() != Type.VOID)
 ...
 ExpressionType traceClassInit()
 {
  ...
  if (terms[0].notEmpty())
  {
   ...
   md.setTraceExprType(curTraceType0 != null ? curTraceType0 : actualType0);
  }
  return null;
 }
}
