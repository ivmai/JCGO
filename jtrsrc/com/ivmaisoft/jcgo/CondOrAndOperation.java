...
final class CondOrAndOperation extends LexNode
{
 ...
 void processPass1(Context c)
 {
  ...
  if (constVal == null || constVal.isNonZero() == isAnd)
  {
   ...
   if (constVal != null)
   {
    ...
    constVal = isAnd ? constVal.bitAnd(constVal2) : constVal.bitOr(constVal2);
   }
  }
 }
 ...
 int tokenCount()
 {
  return constVal != null ? 1 : (omitFirstPart ? 0 :
          terms[0].tokenCount() + 1) + terms[2].tokenCount();
 }

 int tokensExpandedCount()
 {
  return constVal != null ? 0 : omitFirstPart ?
          terms[2].tokensExpandedCount() : super.tokensExpandedCount();
 }
 ...
 {
  return constVal == null && (terms[0].isFieldAccessed(v) ||
          terms[2].isFieldAccessed(v));
 }

 boolean isAnyLocalVarChanged(Term t)
 {
  return constVal == null && (terms[0].isAnyLocalVarChanged(t) ||
