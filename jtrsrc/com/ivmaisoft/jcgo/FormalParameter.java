 ...
 **
 * Format:
 * AccModifier/Empty PrimitiveType/ClassOrIfaceType [Dims] VariableIdentifier [Dims]
 */
...
final class FormalParameter extends LexNode
{
 ...
 Term copyParamList(int[] skip)
 {
  ...
  return new FormalParameter(new AccModifier(AccModifier.SYNTHETIC), terms[1],
          terms[2], (new VariableIdentifier(new LexTerm(LexTerm.ID,
          terms[3].dottedName()))).setLineInfoFrom(terms[3]), terms[4]);
 }
