 ...
 **
 * Formats:
 * DEFAULT COLON [BlockStatements]
 * CASE ConstantExpression COLON [BlockStatements]
 */
...
final class CaseStatement extends LexNode
{
 ...
 void processPass1(Context c)
 {
  ...
  if (terms[0].notEmpty())
  {
   ...
   if (!terms[0].isLiteral() && !terms[0].isJavaConstant(c.currentClass))
