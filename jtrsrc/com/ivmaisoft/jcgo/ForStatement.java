 ...
 **
 * Format:
 * FOR LPAREN [ForInit] SEMI [Expression] SEMI [ForUpdate] RPAREN Statement/StatementNoShortIf
 */
...
final class ForStatement extends BreakableStmt
{
 ...
 {
  super(c.isBlock() ? new LeftBrace() : Empty.newTerm(), c, e, g,
   i.isBlock() ? i : new Block(i), c.isBlock() ? new RightBrace() :
   Empty.newTerm());
 }
 ...
 void processPass1(Context c)
 {
  ...
  if (terms[2].notEmpty() && terms[2].exprType().objectSize() != Type.BOOLEAN)
