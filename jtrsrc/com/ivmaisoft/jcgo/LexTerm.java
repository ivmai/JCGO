...
class LexTerm extends Term
{
 ...
 {
  return Main.dict.classTable[sym == xNULL ? Type.NULLREF :
          sym == FALSE || sym == TRUE ? Type.BOOLEAN : Type.VOID];
 }

 ConstValue evaluateConstValue()
 {
  return sym == FALSE || sym == TRUE || sym == xNULL ?
          new ConstValue(sym == TRUE) : null;
 }
