...
final class Names
{
 ...
 private static final String COM_IVMAISOFT_JPROPJAV_0 =
  COM_IVMAISOFT_0 + "jpropjav.";

 static final String COM_IVMAISOFT_JPROPJAV_STRLISTRESOURCEBUNDLE =
  COM_IVMAISOFT_JPROPJAV_0 + "StrListResourceBundle";

 static final String GNU_0 = "gnu.".toString();

 private static final String GNU_CLASSPATH_0 = GNU_0 + "classpath.";

 static final String GNU_CLASSPATH_SERVICEFACTORY_SERVICEITERATOR =
  GNU_CLASSPATH_0 + "ServiceFactory$ServiceIterator";
 static final String GNU_CLASSPATH_SERVICEPROVIDERLOADINGACTION =
  GNU_CLASSPATH_0 + "ServiceProviderLoadingAction";
 private static final String GNU_CLASSPATH_VMSTACKWALKER =
  GNU_CLASSPATH_0 + "VMStackWalker";

 private static final String GNU_CLASSPATH_JDWP_0 = GNU_CLASSPATH_0 + "jdwp.";
 ...
 static final String JAVA_IO_OBJECTINPUTSTREAM =
  JAVA_IO_0 + "ObjectInputStream";
 static final String JAVA_IO_OBJECTOUTPUTSTREAM =
  JAVA_IO_0 + "ObjectOutputStream";
 static final String JAVA_IO_OBJECTSTREAMCLASS =
  JAVA_IO_0 + "ObjectStreamClass";
 ...
 static final String JAVA_LANG_ARRAYINDEXOUTOFBOUNDSEXCEPTION =
  JAVA_LANG_0 + "ArrayIndexOutOfBoundsException";
 static final String JAVA_LANG_ARRAYSTOREEXCEPTION =
  JAVA_LANG_0 + "ArrayStoreException";
 static final String JAVA_LANG_ASSERTIONERROR =
  JAVA_LANG_0 + "AssertionError";
 ...
 static final String JAVA_LANG_CLASSCASTEXCEPTION =
  JAVA_LANG_0 + "ClassCastException";
 private static final String JAVA_LANG_CLASSLOADER =
  JAVA_LANG_0 + "ClassLoader";
 static final String JAVA_LANG_CLASSLOADER_STATICDATA =
  JAVA_LANG_0 + "ClassLoader$StaticData";
 ...
 static final String JAVA_LANG_INDEXOUTOFBOUNDSEXCEPTION =
  JAVA_LANG_0 + "IndexOutOfBoundsException";
 static final String JAVA_LANG_INTEGER = JAVA_LANG_0 + "Integer";
 static final String JAVA_LANG_LONG = JAVA_LANG_0 + "Long";
 static final String JAVA_LANG_NOSUCHFIELDERROR =
  JAVA_LANG_0 + "NoSuchFieldError";
 static final String JAVA_LANG_NULLPOINTEREXCEPTION =
  JAVA_LANG_0 + "NullPointerException";
 static final String JAVA_LANG_OBJECT = JAVA_LANG_0 + "Object";
 static final String JAVA_LANG_RUNNABLE = JAVA_LANG_0 + "Runnable";
 static final String JAVA_LANG_RUNTIMEEXCEPTION =
  JAVA_LANG_0 + "RuntimeException";
 ...
 static final String JAVA_LANG_STRINGINDEXOUTOFBOUNDSEXCEPTION =
  JAVA_LANG_0 + "StringIndexOutOfBoundsException";
 static final String JAVA_LANG_SYSTEM = JAVA_LANG_0 + "System";
 static final String JAVA_LANG_THREAD = JAVA_LANG_0 + "Thread";
 private static final String JAVA_LANG_THREADGROUP =
  JAVA_LANG_0 + "ThreadGroup";
 ...
 static final String JAVA_LANG_VMTHREAD_EXITMAIN =
  JAVA_LANG_VMTHREAD + "$ExitMain";
 static final String JAVA_LANG_VMTHROWABLE = JAVA_LANG_0 + "VMThrowable";

 private static final String JAVA_LANG_MANAGEMENT_0 =
  JAVA_LANG_0 + "management.";

 static final String JAVA_LANG_REF_0 = JAVA_LANG_0 + "ref.";

 static final String JAVA_LANG_REFLECT_0 = JAVA_LANG_0 + "reflect.";

 static final String JAVA_LANG_REFLECT_CONSTRUCTOR =
  JAVA_LANG_REFLECT_0 + "Constructor";
 static final String JAVA_LANG_REFLECT_FIELD = JAVA_LANG_REFLECT_0 + "Field";
 static final String JAVA_LANG_REFLECT_INVOCATIONHANDLER =
  JAVA_LANG_REFLECT_0 + "InvocationHandler";
 static final String JAVA_LANG_REFLECT_METHOD =
  JAVA_LANG_REFLECT_0 + "Method";
 static final String JAVA_LANG_REFLECT_PROXY = JAVA_LANG_REFLECT_0 + "Proxy";
 static final String JAVA_LANG_REFLECT_VMCONSTRUCTOR =
  JAVA_LANG_REFLECT_0 + "VMConstructor";
 static final String JAVA_LANG_REFLECT_VMFIELD =
  JAVA_LANG_REFLECT_0 + "VMField";
 static final String JAVA_LANG_REFLECT_VMMETHOD =
  JAVA_LANG_REFLECT_0 + "VMMethod";
 static final String JAVA_LANG_REFLECT_VMPROXY =
  JAVA_LANG_REFLECT_0 + "VMProxy";

 private static final String JAVA_NET_0 = JAVA_0 + "net.";

 private static final String JAVA_NIO_0 = JAVA_0 + "nio.";

 static final String JAVA_NIO_VMDIRECTBYTEBUFFER =
  JAVA_NIO_0 + "VMDirectByteBuffer";

 private static final String JAVA_UTIL_0 = JAVA_0 + "util.";

 static final String JAVA_UTIL_LISTRESOURCEBUNDLE =
  JAVA_UTIL_0 + "ListResourceBundle";

 private static final String JAVA_UTIL_LOGGING_0 = JAVA_UTIL_0 + "logging.";

 static final String JAVA_UTIL_LOGGING_LOGMANAGER =
  JAVA_UTIL_LOGGING_0 + "LogManager";

 static final String JAVAX_0 = "javax.".toString();

 private static final String JAVAX_SWING_0 = JAVAX_0 + "swing.";

 static final String JAVAX_SWING_UIDEFAULTS_PROXYLAZYVALUE =
  JAVAX_SWING_0 + "UIDefaults$ProxyLazyValue";

 private static final String JAVAX_SWING_PLAF_0 = JAVAX_SWING_0 + "plaf.";

 static final String JAVAX_SWING_PLAF_COLORUIRESOURCE =
  JAVAX_SWING_PLAF_0 + "ColorUIResource";
 ...
 static final String SIGN_APPEND_STRING =
  "append(" + signame(JAVA_LANG_STRING) + ")";

 static final String SIGN_ARRAYCLASSOF0X =
  "arrayClassOf0X(" + signame(JAVA_LANG_CLASS) + Type.sig[Type.INT] + ")";

 static final String SIGN_ARRAYCOPY =
  "arraycopy(" + signame(JAVA_LANG_OBJECT) + Type.sig[Type.INT] +
  signame(JAVA_LANG_OBJECT) + Type.sig[Type.INT] + Type.sig[Type.INT] + ")";

 static final String SIGN_CLONE0 =
  "clone0(" + signame(JAVA_LANG_OBJECT) + ")";

 static final String SIGN_CONCAT0X =
  "concat0X(" + signame(JAVA_LANG_STRING) + signame(JAVA_LANG_STRING) + ")";

 static final String SIGN_DESTROYJAVAVM0X =
  "destroyJavaVM0X(" + signame(JAVA_LANG_OBJECT) + Type.sig[Type.INT] + ")";

 static final String SIGN_FINALIZE = "finalize()".toString();

 static final String SIGN_FINALIZEOBJECT0X =
  "finalizeObject0X(" + signame(JAVA_LANG_OBJECT) + ")";

 static final String SIGN_FORNAME =
  "forName(" + signame(JAVA_LANG_STRING) + ")";
 static final String SIGN_FORNAME_2 =
  "forName(" + signame(JAVA_LANG_STRING) + Type.sig[Type.BOOLEAN] +
  signame(JAVA_LANG_CLASSLOADER) + ")";

 static final String SIGN_GETCLASS = "getClass()".toString();

 static final String SIGN_GETCONSTRUCTOR =
  "getConstructor([" + signame(JAVA_LANG_CLASS) + ")";

 static final String SIGN_GETCONSTRUCTORS = "getConstructors()".toString();

 static final String SIGN_GETDECLAREDCONSTRUCTOR =
  "getDeclaredConstructor([" + signame(JAVA_LANG_CLASS) + ")";

 static final String SIGN_GETDECLAREDCONSTRUCTORS =
  "getDeclaredConstructors()".toString();

 static final String SIGN_GETDECLAREDFIELD =
  "getDeclaredField(" + signame(JAVA_LANG_STRING) + ")";

 static final String SIGN_GETDECLAREDFIELDS =
  "getDeclaredFields()".toString();

 static final String SIGN_GETDECLAREDMETHOD =
  "getDeclaredMethod(" + signame(JAVA_LANG_STRING) +
  "[" + signame(JAVA_LANG_CLASS) + ")";

 static final String SIGN_GETDECLAREDMETHODS =
  "getDeclaredMethods()".toString();

 static final String SIGN_GETFIELD =
  "getField(" + signame(JAVA_LANG_STRING) + ")";

 static final String SIGN_GETFIELDS = "getFields()".toString();

 static final String SIGN_GETINTERFACES = "getInterfaces()".toString();

 static final String SIGN_GETMETHOD =
  "getMethod(" + signame(JAVA_LANG_STRING) + "[" + signame(JAVA_LANG_CLASS) +
  ")";
 ...
 static final String SIGN_GETPROXYCLASS =
  "getProxyClass(" + signame(JAVA_LANG_CLASSLOADER) +
  "[" + signame(JAVA_LANG_CLASS) + ")";

 static final String SIGN_INVOKEPROXYHANDLER0X =
  "invokeProxyHandler0X(" + signame(JAVA_LANG_OBJECT) +
  signame(JAVA_LANG_CLASS) + "[" + Type.sig[Type.INT] +
  "[" + Type.sig[Type.LONG] + "[" + Type.sig[Type.FLOAT] +
  "[" + Type.sig[Type.DOUBLE] + "[" + signame(JAVA_LANG_OBJECT) +
  Type.sig[Type.INT] + Type.sig[Type.INT] +")";
 ...
 static final String SIGN_NEWINSTANCE_CTOR =
  "newInstance([" + signame(JAVA_LANG_OBJECT) + ")";

 static final String SIGN_NEWPROXYINSTANCE =
  "newProxyInstance(" + signame(JAVA_LANG_CLASSLOADER) + "[" +
  signame(JAVA_LANG_CLASS) + signame(JAVA_LANG_REFLECT_INVOCATIONHANDLER) +
  ")";

 static final String SIGN_ORDINAL = "ordinal()".toString();

 static final String SIGN_READOBJECT =
  "readObject(" + signame(JAVA_IO_OBJECTINPUTSTREAM) + ")";
 ...
 static final String SIGN_SETSYSTEMOUT =
  "setSystemOut(" + signame(JAVA_IO_PRINTSTREAM) + ")";

 static final String SIGN_VALUEOF_ENUM =
  "valueOf(" + signame(JAVA_LANG_CLASS) + signame(JAVA_LANG_STRING) + ")";

 static final String SIGN_WRITEOBJECT =
  "writeObject(" + signame(JAVA_IO_OBJECTOUTPUTSTREAM) + ")";

 static final String SIGN_WRITEREPLACE = "writeReplace()".toString();

 static final String SIGN_INIT_INT = "<init>(" + Type.sig[Type.INT] + ")";

 static final String SIGN_INIT_INVOCATIONHANDLER =
  "<init>(" + signame(JAVA_LANG_REFLECT_INVOCATIONHANDLER) + ")";

 static final String SIGN_INIT_STRING =
  "<init>(" + signame(JAVA_LANG_STRING) + ")";

 static final String SIGN_INIT_STRING_OBJECTS =
  "<init>(" + signame(JAVA_LANG_STRING) +
  "[" + signame(JAVA_LANG_OBJECT) + ")";

 static final String SIGN_INIT_STRING_STRING =
  "<init>(" + signame(JAVA_LANG_STRING) + signame(JAVA_LANG_STRING) + ")";

 static final String SIGN_INIT_STRING_STRING_OBJECTS =
  "<init>(" + signame(JAVA_LANG_STRING) + signame(JAVA_LANG_STRING) +
  "[" + signame(JAVA_LANG_OBJECT) + ")";

 static final String SIGN_INIT_STRINGBUILDER =
  "<init>(" + signame(JAVA_LANG_STRINGBUILDER) + ")";

 static final String SIGN_INIT_THREADGROUP_2 =
  "<init>(" + signame(JAVA_LANG_THREADGROUP) + signame(JAVA_LANG_RUNNABLE) +
 ...
 static final String SERIALPERSISTENTFIELDS =
 ...
 static boolean isVMCoreClass(String name)
 {
  return name.startsWith(GNU_CLASSPATH_JDWP_0) ||
          ...
          (name.startsWith(JAVA_LANG_0) &&
          !name.equals(JAVA_LANG_VMPROCESS)) ||
